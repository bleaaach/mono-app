...
export const TrendUpIcon = ({ size = 24, color = "#000000" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M7 17l5-5 4 4 5-6"
      stroke={color}
...
export const TrendDownIcon = ({ size = 24, color = "#000000" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M7 7l5 5 4-4 5 6"
      stroke={color}
...
export const TrendStableIcon = ({ size = 24, color = "#000000" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M5 12h14"
      stroke={color}
...
export const UploadIcon = ({ size = 24, color = "#000000" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"
      stroke={color}
...
export const FileSpreadsheetIcon = ({ size = 24, color = "#000000" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"
      stroke={color}
